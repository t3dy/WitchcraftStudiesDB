...
| `demonological_concept` | 20 | `concept-name` | `witches-sabbath-collective` |
| `demonological_scholar` | 31 | `surname-firstname-bYYYY` | `ginzburg-carlo-b1939` |
| `scholarly_text` | 20 | `surname-title-word-year` | `clark-thinking-with-demons-2001` |
...
| `timeline` | 29 | `event-descriptor-year` | `malleus-maleficarum-published-1487` |
